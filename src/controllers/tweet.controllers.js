...
const updateTweet = asyncHandler(async (req, res) => {
  ...
  if(tweet.owner.toString() !== req.user._id.toString()){
    throw new ApiError(400, "User is unauthorized to update the tweet of another user.");
  }
...
const deleteTweet = asyncHandler(async (req, res) => {
  ...
  if(tweet.owner.toString() !== req.user._id.toString()){
    throw new ApiError(400, "User is unauthorized to delete tweets of another user.")
  }
